...
func TestInitLogging(t *testing.T) {
	...
	t.Run("Valid Configuration JSON", func(t *testing.T) {
		...
		logger, err := InitLogging(opts.LogDev, opts.LogEncoder, opts.LogStacktraceLevel, &buf)
...
func TestSetupLogger(t *testing.T) {
	...
	t.Run("Setup Logger", func(t *testing.T) {
		...
		var buf bytes.Buffer
		_, err := setupLogger(opts.LogDev, opts.LogEncoder, opts.LogStacktraceLevel, &buf)
		assert.NoError(t, err)
	})
